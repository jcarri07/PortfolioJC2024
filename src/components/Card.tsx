...
export default function Card({title, text}: CardTypes) {
  return (
    <div className="flex justify-center items-center bg-gradient-to-r from-tahiti-primary via-tahiti-secondary to-tahiti-tertiary w-80 h-96 rounded-2xl shadow-lg shadow-cyan-500/50 ...">
