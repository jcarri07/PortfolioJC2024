    ...
    <>
      {horizontal ? (
        <div className="flex w-96 h-72 smartphone:w-64 smartphone:h-52">
          ...
          <div
            className="flex justify-center items-center bg-gradient-to-r from-tahiti-primary via-tahiti-secondary to-tahiti-tertiary w-96 h-72 smartphone:h-44 smartphone:w-60 absolute ml-10 mt-10 smartphone:ml-5 smartphone:mt-5 rounded-2xl shadow-lg shadow-cyan-500/50"
          >
